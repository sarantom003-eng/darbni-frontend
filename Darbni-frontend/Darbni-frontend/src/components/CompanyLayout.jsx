...
const NAV = [
  ...
  { label: "Company Profile",     to: "/company/profile",     icon: <FaUser /> },
  { label: "Post Internship",     to: "/company/post",        icon: <FaPaperPlane /> },
  { label: "Manage Internships",  to: "/company/internships", icon: <FaBriefcase /> },
  { label: "Student Requests",    to: "/company/students",    icon: <FaUsers /> },
  { label: "University Requests", to: "/company/university",  icon: <FaUniversity /> },
  { label: "Intern Progress",     to: "/company/progress",    icon: <FaChartBar /> },
