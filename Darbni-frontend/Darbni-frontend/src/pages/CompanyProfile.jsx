...
const DEFAULT_COMPANY = {
  ...
  about:    "TechPal Solutions is a leading tech company specializing in building innovative software products. We mentor the next generation of developers through hands-on training programs.",
  location: "Ramallah, Palestine",
  website:  "www.techpal.ps",
...
export default function CompanyProfile() {
  ...
  const [trDraft, setTrDraft] = useState(DEFAULT_TRAINER);
  ...
  const handleLogoChange = (e) => {
    ...
    editing ? setLogoDraft(url) : setCompanyLogo(url);
  };
  ...
  const handleAvatarChange = (e) => {
    ...
    if (!file) return;
    const url = URL.createObjectURL(file);
    editing ? setAvatarDraft(url) : setTrainerAvatar(url);
  };
